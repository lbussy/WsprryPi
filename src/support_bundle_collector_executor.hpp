...
public:
    SupportBundleCollectorExecutor(std::string executable, std::chrono::milliseconds timeout = std::chrono::minutes(10), std::chrono::milliseconds grace = std::chrono::seconds(2));
