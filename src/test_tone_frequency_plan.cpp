...
#include <cmath>
#include <limits>
TestToneFrequencyPlanResult plan_explicit_test_tone_frequency(const ParsedTestToneRequest&r,double offset,const std::string& profile,const std::unordered_map<std::string,std::string>& preferences){
