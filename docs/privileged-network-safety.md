...
There is no separate off-LAN read-only WebSocket path.
...
Eligible interfaces are active non-loopback Ethernet or Wi-Fi interfaces with a usable IPv4 or IPv6 address and netmask/prefix. Discovery excludes:
