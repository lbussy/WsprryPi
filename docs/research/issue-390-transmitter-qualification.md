...
Conducted qualification completed all eight cells from Issue 390. Three cells
qualified and five did not meet the carrier gate.

| Band | Backend | Carrier gate | WSPR decode gate | Disposition |
|---|---|---:|---:|---|
| 2200 m | GPIO | Failed twice | Not run | Unqualified |
...
The Mac, `wspr4`, and `wspr5` were clean and synchronized before RF testing:
...
Small reviewed logs, decoder results, JSON summaries, and SHA-256 manifests
are retained in
[`issue-390-transmitter-qualification/`](issue-390-transmitter-qualification/).
Raw complex-IQ files remain on `wspr5` under `/home/pi/issue390/`; their hashes
are recorded beside the reviewed evidence.
